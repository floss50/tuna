...
from squid_py.modules.v0_1.payment import lockPayment
...
lockPayment(ocean._web3, ocean.keeper.contract_path, ocean.main_account, sa_id, service_def)

print("__result__{}".format('payed'))
